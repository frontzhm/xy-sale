...
export default async function InboundDetailPage({ params }: { params: Promise<Params> }) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-4">
          <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">入库登记详情</h1>
          <Link
